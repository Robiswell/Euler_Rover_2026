#!/usr/bin/env python3
"""
Hexapod rover kinematics - STS3215 servos, Raspberry Pi 3B+ (TRIPOD DEFAULT VARIANT)
# Auto-generated by /clon-tripod. Do not edit manually.
# Regenerate after applying fixes to final_full_gait_test.py.
